...
exports.JSONPatcherProxy = void 0;
  ...
  */
  ...
  function trapForSet(instance, tree, key, newValue) {
    ...
    */
    ...
    const isNonSerializableArrayProperty = isTreeAnArray && !Number.isInteger(+key.toString()); // if the new value is an object, make sure to watch it
    ...
    if (newValue && typeof newValue == 'object' && !instance._treeMetadataMap.has(newValue)) {
      if (isNonSerializableArrayProperty) {
        ...
        instance._parenthoodMap.set(newValue, {
          parent: tree,
          key
        });
  ...
  function JSONPatcherProxy(root, showDetachedWarning) {
    ...
    this._parenthoodMap = new Map(); // default to true
  ...
  JSONPatcherProxy.prototype._generateProxyAtKey = function (parent, tree, key) {
    ...
    const treeMetadata = Proxy.revocable(tree, handler); // cache the object that contains traps to disable them later.
...
exports.JSONPatcherProxy = JSONPatcherProxy;
